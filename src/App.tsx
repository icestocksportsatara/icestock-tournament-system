...
type NavTab = 'DASHBOARD' | 'SUPER_ADMIN' | 'RINKS_REFEREES' | 'LIVE_SCORING' | 'TOURNAMENTS' | 'RANKINGS' | 'REPORTS' | 'OFFLINE_HUB' | 'SCHEMA' | 'EQUIPMENT_3D';
      ...
      <header className="sticky top-0 z-40 bg-[#030712]/90 backdrop-blur-xl border-b border-cyan-500/20 px-4 md:px-8 py-3.5 flex items-center justify-between shadow-2xl">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gradient-to-r from-teal-500/20 to-emerald-500/20 border border-emerald-500/40 text-emerald-300 hover:bg-emerald-500/30 text-xs font-mono font-bold shadow-lg shadow-emerald-500/10 transition-all hover:scale-105"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-900 border border-slate-700 hover:border-cyan-500/50 text-xs font-mono font-bold text-slate-200 transition-all"
          ...
          {/* Super Admin Quick Master Settings Button */}
          <button
      ...
      <nav className="bg-slate-950/90 border-b border-slate-800/80 px-4 md:px-8 py-2 overflow-x-auto select-none">
        <div className="flex items-center gap-2 min-w-max">
          {[
            ...
            { id: 'SUPER_ADMIN', label: 'Super Admin Master Settings', icon: Shield, isSuperOnly: true },
